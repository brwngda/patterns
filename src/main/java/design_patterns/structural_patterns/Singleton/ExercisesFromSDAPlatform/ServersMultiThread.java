...
public class ServersMultiThread {
    ...
    private static ServersMultiThread instance;

    public ServersMultiThread getInstance() {
        if (instance == null) {
            synchronized (ServersMultiThread.class) {
                if (instance == null) {
                    instance = new ServersMultiThread();
                }
            }
        }
        return instance;
